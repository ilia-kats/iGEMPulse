...
class igemTeamSpider(BaseSpider):
    name = "teams"
    allowed_domains = ["igem.org"]
    dataset = jsonImport("whole_dataset.json")
#    print dataset[0]
    start_urls = []
    i = 0
#    start_urls.append(dataset[0]["teamInfo"])
#    print dataset[0]["teamInfo"]
    for t in dataset:
        start_urls.append(t["teamInfo"])
#        print '%d) %s' % (i, t["teamInfo"])
        i += 1
#    print "TEST"
